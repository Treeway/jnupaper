<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TchEnterScoreForm.aspx.cs" Inherits="Defence.aspx.TchEnterScoreForm" %>
            ...
            <asp:Panel ID="m_tchPaperReviewPanel" runat="server" Style="position: absolute; top: 216px; left: 327px; height: 514px; width: 887px; margin-left: 0px;">
                ...
                <table style="width: 100%; margin-top: 0px; height: 254px;" class="login-help">
                    <tr class="tr">
                        <td class="td"> 论文题目:</td>
                        <td class="td">
                            <asp:DropDownList ID="m_PaperTitleDropDownList" runat="server" Autopostback="true" OnSelectedIndexChanged="m_PaperTitleChange_IndexChanged"/>
                        </td>
                    </tr>
                    <tr class="tr">
                        <td class="td">论文编号：</td>
                        <td class="td">
                            <asp:Label ID="m_PaperIdLabel" runat="server" />
                        </td>
                    </tr>
                    <tr class="tr">
                        <td class="td">学生姓名：</td>
                        <td class="td">
                            <asp:Label ID="m_StudentNameLabel" runat="server" />
                        </td>
                    </tr>
                    <tr class="tr">
                        <td class="td">学生学号：</td>
                        <td class="td">
                            <asp:Label ID="m_StudentIdLabel" runat="server" />
                        </td>
                    </tr>
                    <tr class="tr">
                        <td class="td">论文成绩：</td>
                        <td class="td">
                            <asp:TextBox ID="m_PaperScoreTextBox" runat="server" />
                        </td>
                    </tr>
                    <tr class="tr">
                        <td class="td"></td>
                        <td class="td">
                            <asp:Button ID="m_EnterScoreConfirmButton" runat="server" Height="25px" Text="录入" Width="65px" OnClick="m_ReplyNotifyConfirmButton_Click" />
                        </td>
                    </tr>
                </table>
                <br />
